...
API_ID = int(environ.get('API_ID', '22512309'))
API_HASH = environ.get('API_HASH', '02f8611f2f78cbd92af651646b8e20ee')
BOT_TOKEN = environ.get('BOT_TOKEN', '5380344611:AAHhgYrHEb-xzIh9XN0-BdcC6lZedrvzHwI')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5600037948').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001319769770').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "Bikashji@cluster0.zugvr6j.mongodb.net")
DATABASE_NAME = environ.get('DATABASE_NAME', "Bikashji")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Anurag_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001728848306'))
